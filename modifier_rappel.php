...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $type_vaccin_name = $row['name']; // Le nom du vaccin
		$recommended_doses = $row['recommended_doses'];
       
		
		// Calcul de la date du prochain rappel
        if ($dose < $recommended_doses) {
			// S'il reste des doses à administrer
			$rappel_effectue = "non";
        } else { $prochain_rappel = null;}

        // Insertion dans la table vaccinations avec le nom du vaccin
...
<body>
    <div class="page-container">
        ...
        <header class="page-header">
            ...
            <p class="mb-0 mt-2">Enregistrement et suivi des vaccinations</p>
        </header>
        ...
        <div class="form-card">
            ...
            <form method="POST" id="vaccinationForm">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="type_vaccin" name="type_vaccin" required>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    $selected = ($vaccination && $row['id'] == $vaccination['type_vaccin_id']) ? 'selected' : '';
                                    echo "<option value='" . htmlspecialchars($row['id']) . "' $selected>" 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="date_vaccination" class="form-label required-field">Date d'administration</label>
                            <input type="text" class="form-control" id="date_vaccination" name="date_vaccination" 
                                   value="<?php echo $vaccination ? htmlspecialchars($vaccination['date_vaccination']) : ''; ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="dose" name="dose" 
                                   value="<?php echo $vaccination ? htmlspecialchars($vaccination['dose']) : '1'; ?>" 
                                   min="1" required>
