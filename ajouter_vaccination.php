                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="date_vaccination"
                                            name="date_vaccination" required>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="dose" name="dose" min="1"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="prochain_rappel"
                                            name="prochain_rappel" required>
                                    </div>
                                </div>
                            </div>
                            <div class="text-end">
